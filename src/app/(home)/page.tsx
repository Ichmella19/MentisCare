      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        >
          <h2
                            ...
                            style={{ fontFamily: 'Montserrat, sans-serif' }}
                        >
                            <span         style={{ fontFamily: 'Ibrand, sans-serif' }}>
                               Nos bureaux
                            </span>
                        </h2>
                        <p
                        ...
                        >
                            <span>
                              Retrouvez nos différents sièges au Bénin
                            </span>
                        </p>

        </motion.div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8" style={{ fontFamily: 'Montserrat, sans-serif' }}>
